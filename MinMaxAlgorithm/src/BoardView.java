...
public class BoardView extends Group {
    // the size of the font used to draw pieces, relative to the size of the square
    ...
    public BoardView(ChessGame game, int pixelsPerSquare) {
        ...
        for (int r = 0; r < game.rows; r++) {
            for (int c = 0; c < game.columns; c++) {
                ...
                Text t = new Text(x, y + 12, "" + Chess.colToChar(c) + Chess.rowToChar(r));
        ...
        for (int r = 0; r < game.rows; r++) {
            for (int c = 0; c < game.columns; c++) {
                ...
                if (stone != Chess.NO_STONE) {
                    ...
                    pieceLabels[sqi].setFont(Font.font("Verdana", (int) (pixelsPerSquare * FONT_SCALE)));
    ...
    private void animateMove(Node n, int dx, int dy) {
        ...
        TranslateTransition tt = new TranslateTransition(Duration.millis(1000), n);
